...
import { LockSplType, LockSplIDL } from "./types";
...
export class Context {
    ...
    readonly program: Program<LockSplType>;
    ...
    public static from(
        ...
        const program = new Program(LockSplIDL, programId, anchorProvider);
    ...
    public static withProvider(
        ...
        const program = new Program(LockSplIDL, programId, provider);
        return new Context(provider, provider.wallet, program, fetcher, opts);
    }
    ...
    public constructor(
        ...
        this.program = program as unknown as Program<LockSplType>;
