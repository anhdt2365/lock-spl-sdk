...
// YOUR ACCOUNTS
let ParsableVault = class ParsableVault {
    constructor() { }
    static parse(data) {
        if (!data) {
            return null;
        ...
        try {
            return parseAnchorAccount(types_1.AccountName.Vault, data);
        }
        catch (e) {
...
ParsableVault = __decorate([
    staticImplements()
], ParsableVault);
exports.ParsableVault = ParsableVault;
