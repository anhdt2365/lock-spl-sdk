...
class Methods {
    ...
    lock(params) {
        return __awaiter(this, void 0, void 0, function* () {
            this.ix = yield ixs.lock(this.ctx.program, params);
            return this;
        });
    }
    changeDestination(params) {
        return __awaiter(this, void 0, void 0, function* () {
            this.ix = yield ixs.changeDestination(this.ctx.program, params);
            return this;
        });
    }
    unlock(params) {
        return __awaiter(this, void 0, void 0, function* () {
            this.ix = yield ixs.unlock(this.ctx.program, params);
            return this;
        });
    }
    toTx() {
